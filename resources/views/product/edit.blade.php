<x-layout>
    ...
    <div class="container mx-auto py-5">
        <x-menu />
        <p class="text-3xl font-black py-5"> 修改商品 </p>
        <p class="text-xs text-red-600">(上方為原始碼,$product內容)</p>
        ...
        <form action="{{ route('product.update', ['product' => $product -> id]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="py-2">
                ...
                <select name="product_type" id="product_type">
                    ...
                    <option value="桌上文具" {{ $product->product_type == '桌上文具' ? 'selected' : ''}}>桌上文具</option>
