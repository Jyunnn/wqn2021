<x-layout>
    ...
    <div class="bg-yellow-300 max-w-full hidden sm:block">
        ...
        <div class="max-w-7xl flex mx-auto py-4 sm:px-0 grid md:grid-cols-4 sm:grid-cols-2 gap-4 ">

            <div class="">
                <div class="border-5 border-yellow-400">
                    <img src="{{ asset('images/office_supplies.jpg') }}" alt="">
                </div>
                <div class="mt-3">
            ...
            <div class="">
                <div>
                    <img class="" src="{{ asset('images/office_ furniture.jpg') }}" alt="">
                </div>
                <div class="mt-3">
                    <div class="box-text-area">
